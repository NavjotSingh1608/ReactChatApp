...
const NewDM = () => {
    ...
    const selectNewContact = async (e) =>{  
        setOpenNewContactModel(false)
        setSelectedChatType("contact")
        setSelectedChatData(e)
        setSearchedContacts([])
    }
                ...
                <DialogContent className="bg-[#181920] border-none text-white h-[400px] w-[400px] flex flex-col ">
                    ...
                    }
                    {
                        searchedContacts.length <= 0 && <div className='flex-1 md:bg-[#1c1d25] md:flex flex-col justify-center items-center duration-1000 transition-all'>
                            ...
                            />
                            <div className="text-opacity-80 text-white flex flex-col gap-5 items-cneter mt-5 lg:text-2xl text-xl transition-all duration-300 text-center">
                                <h3 className='poppins-medium'>
                                    Hi <span className='text-purple-500'> ! </span>
                                    Search new Contact </h3>
                            </div>
                        </div>
                    }
                </DialogContent>
